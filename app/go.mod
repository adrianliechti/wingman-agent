module github.com/adrianliechti/wingman-agent/app

go 1.26.0

require (
	github.com/adrianliechti/go-shell v0.1.1
	github.com/adrianliechti/wingman-agent v0.9.1
)
...
require (
	...
	github.com/odvcencio/gotreesitter v0.39.0 // indirect
...
replace github.com/adrianliechti/wingman-agent => ../
